...
/* Smarty version 3.1.42, created on 2022-01-11 11:35:12
  from '/mnt/app/www/resources/views/material/user/index.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.42',
  'unifunc' => 'content_61dcfaf03ea200_09644161',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'e10e24b4b91fc61a43bf01763ed3f8a48700f1b7' => 
    array (
      0 => '/mnt/app/www/resources/views/material/user/index.tpl',
      1 => 1640286888,
      2 => 'file',
    ),
  ),
...
function content_61dcfaf03ea200_09644161 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->smarty->ext->_tplFunction->registerTplFunctions($_smarty_tpl, array (
  'printClient' => 
  array (
    'compiled_filepath' => '/mnt/app/www/storage/framework/smarty/compile/e10e24b4b91fc61a43bf01763ed3f8a48700f1b7_0.file.index.tpl.php',
    'uid' => 'e10e24b4b91fc61a43bf01763ed3f8a48700f1b7',
    'call_name' => 'smarty_template_function_printClient_99957210361dcfaf0203634_75222657',
  ),
));
...
%);">
                            ...
                            <?php if ($_smarty_tpl->tpl_vars['config']->value['enable_checkin'] == true) {?>
                            <div class="card-inner margin-bottom-no">
                                ...
                                <?php }?>
                                <?php if ($_smarty_tpl->tpl_vars['config']->value['enable_checkin_captcha'] == true && $_smarty_tpl->tpl_vars['config']->value['captcha_provider'] == 'recaptcha' && $_smarty_tpl->tpl_vars['user']->value->isAbleToCheckin()) {?>
...
"><i class="material-icons icon-sm">send</i> 拷贝订阅链接</a>.<a id="general_ss" class="copy-config btn-dl" onclick=Copyconfig("/user/getUserAllURL?type=ss","#general_ss","")><i class="material-icons icon-sm">send</i> 拷贝全部节点 URL</a>
                                                </p>
                                                <hr/>
...
"><i class="material-icons icon-sm">send</i> 拷贝订阅链接</a>.<a id="general_v2ray" class="copy-config btn-dl" onclick=Copyconfig("/user/getUserAllURL?type=v2ray","#general_v2ray","")><i class="material-icons icon-sm">send</i> 拷贝全部节点 URL</a>
                                                ...
                                                <p><span class="icon icon-lg text-white">filter_4</span> [ Trojan ]：
                                                    <a class="copy-text btn-dl" data-clipboard-text="<?php echo $_smarty_tpl->tpl_vars['subInfo']->value['trojan'];?>
"><i class="material-icons icon-sm">send</i> 拷贝订阅链接</a>
                                                </p>
                                                <hr/>
                                                <p><span class="icon icon-lg text-white">filter_5</span> [ Clash ]：
                                                    <a class="copy-text btn-dl" data-clipboard-text="<?php echo $_smarty_tpl->tpl_vars['subInfo']->value['clash'];?>
"><i class="material-icons icon-sm">send</i> 拷贝订阅链接</a>
                                                </p>
                                            </div>
                                            <div class="tab-pane fade" id="sub_center_windows">
                                                <p><span class="icon icon-lg text-white">filter_1</span> Shadowsocks Windows - [ SS ]：</p>
                                                    <p>
                                                        应用下载：
                                                        <?php if ($_smarty_tpl->tpl_vars['config']->value["subscribe_client"] === true) {?><a class="btn-dl" href="<?php if ($_smarty_tpl->tpl_vars['config']->value["subscribe_client_url"] == '') {?>/user/getPcClient<?php } else {
echo $_smarty_tpl->tpl_vars['config']->value["subscribe_client_url"];?>
/getClient/<?php echo $_smarty_tpl->tpl_vars['getClient']->value;
}?>?type=ss-win"><i class="material-icons icon-sm">cloud_download</i> 本站下载</a>
                                                        .<?php }?>
...
echo $_smarty_tpl->tpl_vars['config']->value["subscribe_client_url"];?>
/getClient/<?php echo $_smarty_tpl->tpl_vars['getClient']->value;
}?>?type=ssr-win<?php } else { ?>/clients/ssr-win.7z<?php }?>"><i class="material-icons icon-sm">cloud_download</i> 本站下载</a>
                                                    </p>
                                                    <p>
                                                        使用方式：
                                                        <a class="copy-text btn-dl" data-clipboard-text="<?php echo $_smarty_tpl->tpl_vars['subInfo']->value['ssr'];?>
...
echo $_smarty_tpl->tpl_vars['config']->value["subscribe_client_url"];?>
/getClient/<?php echo $_smarty_tpl->tpl_vars['getClient']->value;
}?>?type=v2rayn-win<?php } else { ?>/clients/v2rayn.zip<?php }?>"><i class="material-icons icon-sm">cloud_download</i> 本站下载 </a>
                                                        .
...
"><i class="material-icons icon-sm">send</i> 拷贝 V2Ray 订阅链接</a>
                                                        .
                                                        <a class="copy-text btn-dl" data-clipboard-text="<?php echo $_smarty_tpl->tpl_vars['subInfo']->value['trojan'];?>
"><i class="material-icons icon-sm">send</i> 拷贝 Trojan 订阅链接</a>
                                                        .
...
","shadowrocket://add/sub://")><i class="material-icons icon-sm">send</i> 一键导入 Shadowrocket</a>
                                                ...
                                                <p>
                                                    使用方式：
                                                    <a class="btn-dl" href="stash://install-config?url=<?php echo urlencode($_smarty_tpl->tpl_vars['subInfo']->value['clash']);?>
"><i class="material-icons icon-sm">send</i> 一键导入 Stash</a>
                                                    .
                                                    <a class="btn-dl" href="<?php echo $_smarty_tpl->tpl_vars['subInfo']->value['clash'];?>
"><i class="material-icons icon-sm">send</i> 配置文件下载</a>
                                                </p>
...
"><i class="material-icons icon-sm">send</i> 拷贝订阅链接</a>
                                                ...
                                                <hr/>
                                                    ...
                                                    <p>
                                                        使用方式：
                                                        <a class="copy-text btn-dl" data-clipboard-text="<?php echo $_smarty_tpl->tpl_vars['subInfo']->value['anxray'];?>
"><i class="material-icons icon-sm">send</i> 拷贝订阅链接</a>
                                                    </p>
                                                <hr/>
...
"><i class="material-icons icon-sm">send</i> 拷贝该应用专属订阅链接</a>
                                                ...
                                                <hr/>
                                                    ...
                                                    <p>
                                                        使用方式：
                                                        <a class="copy-text btn-dl" data-clipboard-text="<?php echo $_smarty_tpl->tpl_vars['subInfo']->value['clash'];?>
"><i class="material-icons icon-sm">send</i> 拷贝 Clash 订阅链接</a>
                                                        .
                                                        <a class="btn-dl" href="clash://install-config?url=<?php echo urlencode($_smarty_tpl->tpl_vars['subInfo']->value['clash']);?>
"><i class="material-icons icon-sm">send</i> 配置一键导入</a>
                                                    </p>
    ...
    window.onload = function () {
        ...
        function shakeEventDidOccur() {
            ...
            $.ajax({
                ...
                url: "/user/checkin",
                dataType: "json",
                <?php if ($_smarty_tpl->tpl_vars['config']->value['enable_checkin_captcha'] == true && $_smarty_tpl->tpl_vars['config']->value['captcha_provider'] == 'recaptcha') {?>
                data: {
...
/* smarty_template_function_printClient_99957210361dcfaf0203634_75222657 */
if (!function_exists('smarty_template_function_printClient_99957210361dcfaf0203634_75222657')) {
function smarty_template_function_printClient_99957210361dcfaf0203634_75222657(Smarty_Internal_Template $_smarty_tpl,$params) {
$params = array_merge(array('items'=>null), $params);
foreach ($params as $key => $value) {
$_smarty_tpl->tpl_vars[$key] = new Smarty_Variable($value, $_smarty_tpl->isRenderingCache);
}
$_smarty_tpl->_checkPlugins(array(0=>array('file'=>'/mnt/app/www/vendor/smarty/smarty/libs/plugins/modifier.replace.php','function'=>'smarty_modifier_replace',),));
?>
